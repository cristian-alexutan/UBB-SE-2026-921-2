...
namespace AirportAppWebAPI.Controllers
{
    public class RoutesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,RouteType,RecurrenceInterval,StartDate,EndDate,DepartureTime,ArrivalTime,Capacity")] Route route)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,RouteType,RecurrenceInterval,StartDate,EndDate,DepartureTime,ArrivalTime,Capacity")] Route route)
        {
            if (id != route.Id)
            {
                return NotFound();
