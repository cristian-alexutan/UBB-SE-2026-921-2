...
public class CartServiceTests
{
    ...
    {
        Cart existingCart = new Cart(1, new Client(1, "Test Client"), new List<CartItem>());
    ...
    public void AddItemToCart_ItemNotInCartAndStockSufficient_AddsItemToRepo()
    {
        ...
        Cart cart = new Cart(1, new Client(1, "Test Client"), new List<CartItem>());
    ...
    public void AddItemToCart_ItemAlreadyInCart_UpdatesCombinedQuantityInRepo()
    {
        ...
        Cart cart = new Cart(1, new Client(1, "Test Client"), new List<CartItem> { existingCartItem });
    ...
    public void GetCartTotal_CartWithItems_ReturnsCorrectTotal()
    {
        ...
        Cart cart = new Cart(1, new Client(1, "Test Client"), new List<CartItem> { cartItem });
        this.cartRepo.GetById(1).Returns(cart);
    ...
    public void GetCartItems_CartWithItems_ReturnsAllCartItems()
    {
        ...
        Cart cart = new Cart(1, new Client(1, "Test Client"), new List<CartItem> { cartItem1, cartItem2 });
        this.cartRepo.GetById(1).Returns(cart);
